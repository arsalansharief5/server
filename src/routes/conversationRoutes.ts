...
import { markConversationAsSeen, sendMessage } from "../controllers/conversation/messageController";
...
router.post('/:conversationId/mark-seen', authenticate, markConversationAsSeen);
